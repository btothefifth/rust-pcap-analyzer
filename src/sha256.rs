//! SHA-256 for content identity, not a signature or proof of provenance.
//! Known-answer vectors and cross-language fixture checks live in tests/.
const K: [u32; 64] = [
...
impl Sha256 {
    ...
    fn compress(&mut self, block: &[u8; 64]) {
        ...
        for (old, value) in self.state.iter_mut().zip([a, b, c, d, e, f, g, h]) {
