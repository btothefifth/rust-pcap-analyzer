...
response data, controls, writes, authentication, files, attributes, vendor data,
and other groups stop with an explicit unsupported tail. There is no speculative
