...
supported as exact, hash-safe evidence; the opt-in depth sink now adds bounded
multi-APDU file-transfer candidate reconciliation, while endpoint-authoritative
completion, Group 70 authentication variation 2 and secure semantics remain open.
A separate
